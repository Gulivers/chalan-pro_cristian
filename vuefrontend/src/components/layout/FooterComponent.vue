  ...
  <footer class="text-bg-light py-3">
    <div class="container text-center">
      <div class="row">
        ...
        <!-- Right: Support -->
        <div class="col-md-4 mb-2">
          <p>Support: <a href="mailto:oliveralverto@gmail.com" class="footer-link">oliveralverto@gmail.com</a></p>
          <p>📞 Contact: +1 (239) 240-0016</p>
        </div>
      </div>

      <!-- System Status -->
      <div class="mt-2">
        <small>🔔 Last Update: Export Bids to PDF & Contract Modifications by Supervisors.</small>
      </div>
    </div>
  </footer>
</template>
