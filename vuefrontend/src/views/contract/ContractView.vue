  ...
  methods: {
    ...
    initDataTable() {
      if (this.$refs.contractsTable) {
        ...
        const table = $(this.$refs.contractsTable).DataTable({
          processing: true,
          serverSide: true,
          ajax: {
            url: `${BASE_URL}api/contract/datatable-contracts/`,
              ...
              render: (data) => {
                return `
                  <div class="btn-group btn-group-sm">
                    <button class="btn btn-outline-success me-1 view-btn" data-id="${data.id}">View</button>
                    <button class="btn btn-outline-dark me-1 print-btn" data-id="${data.id}">Print</button>
                    <button class="btn btn-outline-primary me-1 edit-btn" data-id="${data.id}">Edit</button>
                    <button class="btn btn-outline-danger me-1 delete-btn" data-id="${data.id}">Edit</button>
                  </div>
                `;
              }
            }
