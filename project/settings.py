...
allowed_hosts_env = os.environ.get(
    'ALLOWED_HOSTS',
    'chalan-frontend.onrender.com,chalan-backend.onrender.com,localhost,127.0.0.1,192.168.0.248,.chalan-pro.net,.onrender.com'
)
...
default_csrf_origins = 'http://localhost:8080,http://192.168.0.248:8080,http://192.168.0.248:3000,http://localhost:8000,http://localhost:3000'
