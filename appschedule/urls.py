...
from .views import (
    EventViewSet, EventsListView, EventNoteViewSet,EventChatViewSet,
    download_schedule_pdf, MyEventsView, export_schedule_excel,
    AbsenceReasonViewSet, WeeklySupervisorStatsChartView,
